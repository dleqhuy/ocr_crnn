...
parser.add_argument(
    "--weight", type=str, required=True, default="", help="The saved weight path."
)
...
for img_path in img_paths:
    img = read_img_and_resize(
        str(img_path), config["img_width"], config["img_height"], config["channel"]
    )
    ...
    print(
        f"Path: {img_path}, y_pred: {y_pred.numpy().astype(str)}, "
